...
public class calcMain {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Type I for imaginary, IF for Imaginary w/ fractions, and F for fractions");
            ...
            if (in.equals("F")) {
                ...
                if (sign.equals("s")) {
                    ...
                    ((ImaginaryFrac) imaginary.divide(imaginary1)).print();
                }
